...
export default function WelcomeBanner() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      // DISABLED: Banner không hiển thị mặc định để web có nền trắng
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-2 sm:p-4 bg-black/80 backdrop-blur-md animate-fadeIn overflow-hidden">
      <div className="relative bg-gradient-to-br from-[#0a0e27] via-[#1a1f3a] to-[#2d3561] rounded-2xl sm:rounded-3xl border-2 border-white/30 shadow-2xl max-w-4xl w-full max-h-[95vh] sm:max-h-[90vh] overflow-y-auto overflow-x-hidden">
        ...
        <div className="absolute top-0 left-0 right-0 h-1.5 sm:h-2 bg-gradient-to-r from-red-600 to-blue-600 shadow-lg shadow-blue-500/50 overflow-hidden" style={{ borderTopLeftRadius: 'inherit', borderTopRightRadius: 'inherit' }}></div>
        ...
        <div className="absolute top-2 left-2 sm:top-4 sm:left-4 flex flex-wrap gap-1.5 sm:gap-2 z-20 max-w-[calc(100%-4rem)] sm:max-w-none">
          <div className="px-2 py-1 sm:px-3 sm:py-1.5 bg-green-500/20 backdrop-blur-sm rounded-full border border-green-400/50 flex items-center gap-1 sm:gap-1.5">
            ...
            <span className="text-green-300 text-[10px] sm:text-xs font-semibold">Đã Xác Minh</span>
          </div>
          <div className="px-2 py-1 sm:px-3 sm:py-1.5 bg-blue-500/20 backdrop-blur-sm rounded-full border border-blue-400/50 flex items-center gap-1 sm:gap-1.5">
            ...
            <span className="text-blue-300 text-[10px] sm:text-xs font-semibold">Đã Chứng Nhận</span>
          </div>
        </div>
        ...
        <div className="relative z-10 p-4 sm:p-6 md:p-8 pt-12 sm:pt-16 md:pt-8">
          ...
          <div className="text-center mb-4 sm:mb-6">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold text-white mb-2 sm:mb-3 px-2">
              <span className="bg-gradient-to-r from-red-600 to-blue-600 bg-clip-text text-transparent drop-shadow-lg">
            ...
            <div className="flex items-center justify-center flex-wrap gap-2 sm:gap-4 mt-3">
              <div className="flex items-center gap-1 sm:gap-1.5">
                ...
                <span className="text-gray-300 text-xs sm:text-sm font-semibold">Đánh giá 4.9/5</span>
              </div>
              ...
              <div className="flex items-center gap-1 sm:gap-1.5">
                ...
                <span className="text-gray-300 text-xs sm:text-sm font-semibold">Giải Thưởng 2025</span>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 sm:gap-3 md:gap-4 mb-4 sm:mb-6">
            ...
            <div className="bg-gradient-to-br from-green-500/30 to-emerald-500/30 backdrop-blur-md rounded-lg sm:rounded-xl p-2.5 sm:p-3 md:p-4 border-2 border-green-400/60 text-center shadow-xl shadow-green-500/30 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-[10px] sm:text-xs md:text-sm text-white font-bold mb-0.5 sm:mb-1">Khách Hàng Hài Lòng</p>
                <p className="text-[9px] sm:text-xs text-green-200 mt-0.5 sm:mt-1 font-medium">Được tin dùng bởi hàng nghìn người</p>
              </div>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-lg sm:rounded-xl p-2.5 sm:p-3 md:p-4 border border-white/20 text-center shadow-lg hover:bg-white/15 transition-all relative overflow-hidden">
              ...
              <p className="text-[10px] sm:text-xs md:text-sm text-white font-bold mb-0.5 sm:mb-1">Đối Tác Được Chứng Nhận</p>
              <p className="text-[9px] sm:text-xs text-gray-400 leading-tight">Nhà phân phối được ủy quyền cho tất cả các nhà mạng lớn Việt Nam</p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-lg sm:rounded-xl p-2.5 sm:p-3 md:p-4 border border-white/20 text-center shadow-lg hover:bg-white/15 transition-all relative overflow-hidden">
              ...
              <p className="text-[10px] sm:text-xs md:text-sm text-white font-bold mb-0.5 sm:mb-1">Giao Dịch An Toàn</p>
              <p className="text-[9px] sm:text-xs text-gray-400 leading-tight">Xử lý thanh toán tuân thủ PCI DSS</p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-lg sm:rounded-xl p-2.5 sm:p-3 md:p-4 border border-white/20 text-center shadow-lg hover:bg-white/15 transition-all relative overflow-hidden">
              ...
              <p className="text-[10px] sm:text-xs md:text-sm text-white font-bold mb-0.5 sm:mb-1">Đảm Bảo Hoàn Tiền</p>
              <p className="text-[9px] sm:text-xs text-gray-400 leading-tight">Đảm bảo hài lòng 30 ngày cho tất cả các gói cước</p>
            </div>
          </div>
            ...
            <div className="space-y-2 sm:space-y-3 md:space-y-4">
              <div className="flex items-start gap-2 sm:gap-3 md:gap-4 bg-white/5 rounded-lg sm:rounded-xl p-3 sm:p-4 border border-white/10 hover:bg-white/10 transition-all">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-white font-bold text-sm sm:text-base md:text-lg mb-0.5 sm:mb-1">Gói Cước Tốt Nhất</p>
                  <p className="text-gray-300 text-xs sm:text-sm">Viettel, Vinaphone, MobiFone & nhiều hơn với giá không thể đánh bại</p>
                </div>
              </div>
              <div className="flex items-start gap-2 sm:gap-3 md:gap-4 bg-white/5 rounded-lg sm:rounded-xl p-3 sm:p-4 border border-white/10 hover:bg-white/10 transition-all">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-white font-bold text-sm sm:text-base md:text-lg mb-0.5 sm:mb-1">Kích Hoạt Tức Thì</p>
                  <p className="text-gray-300 text-xs sm:text-sm">Kích hoạt gói cước của bạn trong vài phút, không phải vài giờ</p>
                </div>
              </div>
              <div className="flex items-start gap-2 sm:gap-3 md:gap-4 bg-white/5 rounded-lg sm:rounded-xl p-3 sm:p-4 border border-white/10 hover:bg-white/10 transition-all">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-white font-bold text-sm sm:text-base md:text-lg mb-0.5 sm:mb-1">Tiết Kiệm Lên Đến 50%</p>
                  <p className="text-gray-300 text-xs sm:text-sm">Giá tốt nhất được đảm bảo không có phí ẩn</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-2 sm:space-y-3">
            <button
              onClick={handleDismiss1Hour}
              className="w-full px-4 sm:px-6 py-2.5 sm:py-3 md:py-4 bg-gradient-to-r from-red-600 to-blue-600 rounded-lg sm:rounded-xl font-bold text-sm sm:text-base md:text-lg hover:from-red-700 hover:to-blue-700 transition-all duration-300 shadow-lg hover:shadow-blue-500/50 hover:scale-105 flex items-center justify-center gap-2 text-white min-h-[44px] sm:min-h-[48px]"
            >
