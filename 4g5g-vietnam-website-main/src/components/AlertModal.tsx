...
export default function AlertModal({ 
  ...
  const typeConfig = {
    info: {
      ...
      buttonBg: 'bg-gradient-to-r from-red-600 to-blue-600 hover:from-red-700 hover:to-blue-700',
    },
    success: {
  ...
  const displayTitle = title || (type === 'success' ? 'Thành công' : type === 'warning' ? 'Cảnh báo' : type === 'error' ? 'Lỗi' : 'Thông báo');
